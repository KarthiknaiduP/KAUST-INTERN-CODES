...
file3 ='/home/dasarih/Desktop/karthik/observations/ncfiles/Ebriq-1_F3_WS_TFCA_file.nc'
file4 ='/home/dasarih/Desktop/karthik/observations/ncfiles/Ebriq-1_F4_WS_TFCA_file.nc'

file12 ='/home/dasarih/Desktop/karthik/day_wp150m_1980-2023_file.nc'
file1 ='/home/dasarih/Desktop/karthik/observations/ncfiles/Ebriq-1_F1_WS_TFCA_file.nc'
file2 ='/home/dasarih/Desktop/karthik/observations/ncfiles/Ebriq-1_F2_WS_TFCA_file.nc'

file13 ='/home/dasarih/Desktop/karthik/day_wp80m_1980-2023_file.nc'
file5 ='/home/dasarih/Desktop/karthik/observations/ncfiles/Ebriq-1_F5_WS_TFCA_file.nc'
file6 ='/home/dasarih/Desktop/karthik/observations/ncfiles/Ebriq-1_F6_WS_TFCA_file.nc'

file14 ='/home/dasarih/Desktop/karthik/day_wp30m_1980-2023_file.nc'
file7 ='/home/dasarih/Desktop/karthik/observations/ncfiles/Ebriq-1_F7_WS_TFCA_file.nc'
file8 ='/home/dasarih/Desktop/karthik/observations/ncfiles/Ebriq-1_F8_WS_TFCA_file.nc'
...
x1_clipped = np.clip(x1, 0, 800)
y1_clipped = np.clip(y1, 0, 800)
...
x2_clipped = np.clip(x2, 0, 800)
y2_clipped = np.clip(y2, 0, 800)
...
x3_clipped = np.clip(x3, 0, 800)
y3_clipped = np.clip(y3, 0, 800)
...
x4_clipped = np.clip(x4, 0, 800)
y4_clipped = np.clip(y4, 0, 800)
...
x5_clipped = np.clip(x5, 0, 800)
y5_clipped = np.clip(y5, 0, 800)
...
x6_clipped = np.clip(x6, 0, 800)
y6_clipped = np.clip(y6, 0, 800)
...
x7_clipped = np.clip(x7, 0, 800)
y7_clipped = np.clip(y7, 0, 800)
...
x8_clipped = np.clip(x8, 0, 800)
y8_clipped = np.clip(y8, 0, 800)
...
fig.suptitle('Ebriq-1', y=0.97, fontsize=25)
...
plt.savefig('ScatterPlot_Ebriq-1_REMOVED.png',format='png',dpi=300)
quit()
